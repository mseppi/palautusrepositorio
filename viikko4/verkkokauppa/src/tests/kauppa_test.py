...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kahden_eri_tuotteen_joista_toinen_loppu_ostoksen_paaytyttya_pankin_metodia_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_kauppa_pyytaa_uuden_viitenumeron_jokaiselle_maksutapahtumalle(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        viitegeneraattori_mock.uusi.assert_called()
    ...
    def test_poista_korista_yksi_tuote(self):
        ...
        # varmistetaan, että tuote on poistunut ja lisääntynyt varastoon
        varasto_mock.palauta_varastoon.assert_called_with(Tuote(2, "leipa", 3))
